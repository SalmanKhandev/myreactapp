...
const Home = () => {
  ...
  const [toggleclassone, setToggleClassone] = useState(false);
  ...
  const clickIcons = () => {
    setToggleClassone(!toggleclassone);
        ...
        <div className="top-round-icons">
          <div className="top-circle-items">
            <div className="color-round">
              <span className={toggleColor ?'color-round':''}>
                <img src="assets/img/plan.png" alt="" />
              </span>
            </div>
            <div className={toggleclassone ? 'ml-main': ' ml-under'}>
              <span className={toggleColor ?'color-round':''}>
                <img src="assets/img/sheild.png" alt="" />
              </span>
            </div>
      ...
      <div className="custom-container">
        <div className="row">
          ...
          <div className="top-round-text">
            <p className="click-collapse" onClick={clickIcons} data-toggle="collapse" data-target="#d2">
            <span>Industory</span> Choose <img src="assets/img/arrowdown.png" alt="" />{" "}
           </p>
      ...
      <div className="custom-container">
        <div className="row">
            <div className="col-sm-2">
              ...
              <div id="d2" style={{marginTop:'-100px'}} className="content-dropdown collapse ">
  <div className="items-drop">
    <label className="radio-inline">
      <input type="checkbox" name="optradio" defaultChecked="" /> Aerospace
    </label>
  </div>
  <div className="items-drop">
    <label className="radio-inline">
      <input type="checkbox" name="optradio" defaultChecked="" /> Healthcare
    </label>
  </div>
  <div className="items-drop">
    <label className="radio-inline">
      <input type="checkbox" name="optradio" defaultChecked="" /> Food &amp;
      Beverage
    </label>
  </div>
  <div className="items-drop">
    <label className="radio-inline">
      <input type="checkbox" name="optradio" /> Defense &amp; Security
    </label>
  </div>
  <div className="items-drop">
    <label className="radio-inline">
      <input type="checkbox" name="optradio" /> Maritime
    </label>
  </div>
  <div className="items-drop">
    <label className="radio-inline">
      <input type="checkbox" name="optradio" /> Oil &amp; Mining
    </label>
  </div>
</div>
